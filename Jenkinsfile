...
String platform='Predictive Analytics';
   try
	{   
	    ...
	    dir('Spell-Checker') 
           {
			 ...
			 def branchCommit = '"' + 'https://api.github.com/repos/syncfusion-content/Predictive-Analytics-docs/pulls/'+env.pullRequestId+'/files'
